...
describe("getPositionStringFromPositions", () => {
    const testCases= [
            ...
            { expected: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR", input:  [
                ...
                { piece: "pawn", side: "black", square: {index: 12, code: "e7"} },
                { piece: "pawn", side: "black", square: {index: 13, code: "f7"} },
                { piece: "pawn", side: "black", square: {index: 14, code: "g7"} },
                { piece: "pawn", side: "black", square: {index: 15, code: "h7"} },
                { piece: "pawn", side: "white", square: {index: 48, code: "a2"} },
                { piece: "pawn", side: "white", square: {index: 49, code: "b2"} },
                { piece: "pawn", side: "white", square: {index: 50, code: "c2"} },
    ...
    it("should return the correct position string", () => {
