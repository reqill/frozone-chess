...
const KNIGHT_DOWN_DOWN_LEFT =
	DOWN_MOVE_INDEX_CHANGE + DOWN_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE;
const KNIGHT_DOWN_DOWN_RIGHT =
	DOWN_MOVE_INDEX_CHANGE + DOWN_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE;
