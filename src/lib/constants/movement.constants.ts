...
const KNIGHT_UP_UP_LEFT = UP_MOVE_INDEX_CHANGE + UP_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE;
const KNIGHT_UP_UP_RIGHT = UP_MOVE_INDEX_CHANGE + UP_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE;
const KNIGHT_UP_LEFT_LEFT = UP_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE;
const KNIGHT_UP_RIGHT_RIGHT = UP_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE;
const KNIGHT_DOWN_DOWN_LEFT = DOWN_MOVE_INDEX_CHANGE + DOWN_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE;
const KNIGHT_DOWN_DOWN_RIGHT = DOWN_MOVE_INDEX_CHANGE + DOWN_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE;
const KNIGHT_DOWN_LEFT_LEFT = DOWN_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE + LEFT_MOVE_INDEX_CHANGE;
const KNIGHT_DOWN_RIGHT_RIGHT = DOWN_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE + RIGHT_MOVE_INDEX_CHANGE;
